...
public sealed class ReservaRepository : IReservaRepository
{
    ...
    /// <summary>
    /// Busca uma reserva incluindo dados de cliente e quadra para operações de cancelamento.
    /// </summary>
    ...
    /// <summary>
    /// Recupera reservas ordenadas por data para exibir na área do cliente.
    /// </summary>
    public async Task<IEnumerable<Reserva>> GetReservasPorClienteAsync(Guid clienteId)
    {
        return await _context.Reservas
            .Include(r => r.Cliente)
            .Include(r => r.Quadra)
